  ...
  handleSelectImage = () => {
    ImagePicker.showImagePicker({
      ...
      if (upload.error) {
        ...
        // Tratamento de imagem para o iOS que salva os arquivos com extensão 'HEIC'.
        let prefix;
        let ext;

        // Tratamento para o iOS que quando tira uma foto o filename não vem presente dentro da imagem, pelo fato da mesma não existir.
        if (upload.fileName) {
